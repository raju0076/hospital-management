...
export default function NursesPage() {
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="text-3xl font-bold text-blue-700 mb-6">NURSES</h1>

      <TabContext value={tab}>
        <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
          <TabList onChange={handleChange}>
            <Tab label="Nurses List" value="1" />
        ...
        <TabPanel value="2">
          <div className="w-full max-w-3xl bg-[#e8edff] border border-blue-200 shadow-lg rounded-xl p-8">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">ADD NURSE</h2>
            ...
            <form className="flex flex-col gap-6">
              ...
              <TextField label="Department" select fullWidth size="small">
                {["ICU", "Emergency", "Pediatrics", "General", "Surgery"].map((d) => (
