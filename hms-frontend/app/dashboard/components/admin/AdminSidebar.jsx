...
export default function AdminSidebar() {
  ...
  items: [
    {
      label: "Pharmacy Home",
      path: "/dashboard/hospital-admin/pharmacy",
      icon: "/icons/pharmacy.png"
    },
    
    {
      label: "Dispense Queue",
      path: "/dashboard/hospital-admin/pharmacy/dispense",
      icon: "/icons/dispense.png"
    },
    {
      label: "Categories",
      path: "/dashboard/hospital-admin/pharmacy/categories",
